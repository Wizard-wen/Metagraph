...
import MetagraphTreeItemPreview from '@/components/metagraph-tree-preview/metagraph-tree-item-preview.vue';
...
app.component('metagraph-tree-item-preview', MetagraphTreeItemPreview);
// 引入全局directive
